...
def fetchdata():
    if request.method == 'POST':
        try:
            ...
            return render_template('GetEmpOutput.html', emp_id=emp_id, first_name=first_name, last_name=last_name, pri_skill=pri_skill, phone=phone, location=location, ot=ot, insurance=insurance, allowance=allowance)
        except Exception as e:
